    ...
    <body>
        <header class="navbar">
            ...
            <div class="navbar-right">
                <a href="StaffNotificationPage.php" target="content-frame" title="Notifications">
                    <i class="fa-solid fa-bell" style="font-size: 25px; margin-right: 20px; color: white;"></i>
                </a>
                
                <i class="fa-solid fa-gear" style="font-size: 25px; margin-right: 20px;"></i>
        ...
        <script>
            ...
            // NOTE: The active tracking logic will only apply to the remaining sidebar items (Reports and Movies).
