...
<body>
   ...
   <div class="nav-holder">
    <nav class="navbar">
      <div class="nav-left">
        <img src="../assets/logo_icon.jpg" alt="Logo" class="logo">
      ...
      <div class="nav-right">
        <img src="../assets/account_icon.png" alt="Account" class="account-icon">
      </div>
    </nav>
  </div>
  ...
  <div class="container">
    ...
    <div class="cinema-container">
      <div class="cinema-card">
        <img src="../assets/smlogo.png" alt="SM Logo">
        <h3>SM</h3>
        <a href="#" class="visit-btn">VISIT</a>
      </div>

      <div class="cinema-card">
        <img src="../assets/robinl.jpg" alt="Robinsons Logo">
        <h3>ROBINSON</h3>
        <a href="#" class="visit-btn">VISIT</a>
      </div>

      <div class="cinema-card">
        <img src="../assets/ayalamlogo.png" alt="Ayala Logo">
        <h3>AYALA</h3>
        <a href="#" class="visit-btn">VISIT</a>
      </div>
    </div>
